...
impl Packet{
    pub fn new_data(content : Vec<u8>, sequence : u64) -> Packet{
        ...
        Packet{size, content, sequence, acked:0, syn:false, ack:false, reset:false}
    }

    pub fn new_ack(sequence : u64, acked : u64) -> Packet{
        Packet{size:0, content:Vec::new(), sequence, acked, syn:false, ack:true, reset:false}
    }

    pub fn new_synack(sequence : u64, acked : u64) -> Packet{
        Packet{size:0, content:Vec::new(), sequence, acked, syn:true, ack:true, reset:false}
    }

    pub fn new_syn(sequence : u64) -> Packet{
        Packet{size:0, content:Vec::new(), sequence, acked:0, syn:true, ack:false, reset:false}
    }

    pub fn new_reset(sequence : u64) -> Packet{
        Packet{size:0, content:Vec::new(), sequence, acked:0, syn:false, ack:false, reset:true}
    }
    ...
    pub fn from_bytes(bytes : Vec<u8>) -> Packet{
        ...
        Packet{size, content, sequence, acked, syn, ack, reset}
    }
}